...
<div class="chat-wrap">
  <div class="panel" style="max-width:520px; margin:0 auto;">
    ...
    <div class="muted" style="margin-bottom:12px;">Login to save chat history.</div>
    ...
    <form method="post" style="display:flex; flex-direction:column; gap:12px;">
      ...
      <div class="muted" style="font-size:13px;">No account? <a class="link" href="register.php">Register</a></div>
    </form>
  </div>
</div>
</body>
